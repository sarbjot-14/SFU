...
def main(infile):
    ...
    #print(data)
    X = data[['R','G','B']].div(255) # array with shape (n, 3). Divide by 255 so components are all 0-1.
    #print(X)
    #print(X)
    ...
    model_lab = make_pipeline(
        FunctionTransformer(to_LAB, validate=True),
        GaussianNB()
    )
    ...
    #print(model_lab.score(X_train, y_train))
