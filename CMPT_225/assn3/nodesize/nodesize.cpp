...
int main (int argc, char * const argv[]) {
	...
	int SIZE = 8000; // size of array to work on.
	int TIMES = 60 ; // number of times to run - mean is reported.
	...
	//btree::btree_set<int,std::less<int>,std::allocator<int>,50> S1 ;
	for( int t = 0 ; t < TIMES ; t++ ){
		btree::btree_set<int,std::less<int>,std::allocator<int>,7000> S1 ;
